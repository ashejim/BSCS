...
Set up an online portfolio using GitHub (or Gitlab). An online portfolio provides an adaptable platform for sharing your work portfolio while demonstrating techincial savy with Git and HTML.  

## What you need to get sarted
