...
1. Sign-in to your account and navigate to your repository tab
    > <img src="https://github.com/ashejim/BSCS/blob/main/url_images/github_repo_tab.png?raw=true" height="50px" alt="repositoy button in GitHub"/>
2. Click the "New" button:
    > <img src="https://github.com/ashejim/BSCS/blob/main/url_images/github_repo_new.png?raw=true" height="50px" />

3. A [GitHub](github.com) account
4. A 
