...
4. Click on the `Actions` tab and watch your website deploy. The URL will be provided when it's done
...
Now edit the files to make it your own. You can edit files through the GitHub website, download files and then upload edited files, or set up a local repository.
