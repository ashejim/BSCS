...
1. Navigate to your repostiory's page and select `Settings`.
2. Under `General` (left panel), choose `Pages`.
3. Under **Branch**, choose `main`, and save.
4. Go to actions and watch it deploy. The URL will be provided when it's done

These steps can be done at any time and using any branch folder provided it contains a `index.html` file.
 

### Step 4: Make it Your Website

Now edit the files to make it your own. You can edit files through the GitHub website, download files and then upload editted files,  browser oneed to edit the files to make it *your portfolio*, and then activate the site. 
