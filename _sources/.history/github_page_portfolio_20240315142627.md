...
Now edit the files to make it your own. You can edit files through the GitHub website, download files and  browser oneed to edit the files to make it *your portfolio*, and then activate the site. 
