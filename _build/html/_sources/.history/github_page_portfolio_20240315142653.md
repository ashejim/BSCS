...
Now edit the files to make it your own. You can edit files through the GitHub website, download files and then upload editted files, or set up a local repository. 
