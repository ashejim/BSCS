...
:width: 200
:alt: Graph showing the growth of functions as $n\righarrow \infty$. Functions growing faster to slower shown are $c^n$, $c \cdot n^{10}$, $c \cdot n^{2}$, $n \log_{c}n$, $c \cdot n$, $\log_{c}n 
```
